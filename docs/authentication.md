...
| 长期 Token | 7天 | 日常认证，WebSocket 连接和 API 请求 |
| Refresh Token | 30天 | 用于刷新过期的长期 Token |
...
- **速率限制**：限制 API 请求频率
- **连接限制**：单设备最多 3 个并发连接，单 IP 最多 10 个连接
- **异常检测**：检测并阻止异常操作
